  ...
  return (
    <div className="w-full min-h-screen bg-linear-to-t relative from-black to-[#030353] flex justify-center items-center flex-col">
      ...
      <div className="text-center mt-6 mb-6 px-4">
        ...
        <p className="text-white/70 text-sm mt-2">Pick a style or upload your own image</p>
      </div>
      ...
      <div className=" w-full max-w-225  flex flex-wrap justify-center items-center gap-4">
        ...
        <div
          ...
          className={`md:w-38 md:h-70 w-30 h-60 bg-[#030026] border-2 border-[#0000ff66] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-950 cursor-pointer hover:border-4 hover:border-white flex justify-center items-center ${
            selectedImage == "input" ? "shadow-2xl  shadow-blue-950 border-4  border-white" : null
          }`}
        >
